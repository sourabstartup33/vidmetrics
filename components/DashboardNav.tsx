...
export default function DashboardNav({ onAnalyze, isLoading }: DashboardNavProps) {
  ...
  return (
    <nav className="sticky top-0 z-40 bg-black border-b border-white/10 h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
      {/* Logo */}
      <Link href="/" className="flex items-center gap-2 shrink-0 relative z-10 w-[200px]">
      ...
      {/* Channel URL analyze form — Absolute centered */}
      ...
      <div className="flex items-center justify-end gap-4 shrink-0 relative z-10 w-[200px]">
